// Extracted from https://timeapi.io/documentation/iana-timezones. The offsets may not be 100% accurate.
// Data has been sorted by UTC offset, same as Google Calendar

// The commented-out entries are not accepted by the API:
// CET, EST, EET, UCT, WET, UCT, HST, MET, MST, PRC, ROC, ROK
// Other similar entries are accepted however: GMT, GMT0, UTC, GB, NZ, Zulu, Universal, EST5EDT, CST6CDT, Etc/UTC
