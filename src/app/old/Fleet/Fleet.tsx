    ...
    return (
        <PageSection >
            <Breadcrumb>
                ...
                <BreadcrumbItem to="#" isActive>{fleetID}</BreadcrumbItem>
            </Breadcrumb>
            <Title headingLevel="h1" size="3xl">{fleetID}</Title>
            <Card style={{ width: "50%", background: "#f0f0f0"}} >
                ...
                <CardBody>
                    ...
                    <table >
                        <thead>
                            <tr>
                                <th style={{ padding: "0 20px" }}><b>Created</b></th>
                                <th style={{ padding: "0 20px" }}><b>Created by</b></th>
                                <th style={{ padding: "0 20px" }}><b>Status</b></th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
