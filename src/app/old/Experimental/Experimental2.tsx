    ...
    if (auth?.user?.access_token) {
      fetchData('devices', auth?.user?.access_token).then((datad) => {
        ...
        */
        ...
        const fleets = ['solarpannels', 'batteries', 'engines', 'amplifiers', 'sensors'];

        const regions = ['eu-west-1', 'us-west-1', 'us-west-2'];
        ...
        */
        ...
        devices.forEach((device: any) => {
          ...
          line.push(
            <CubeIcon
              style={{ paddingRight: '0px', opacity: device.color === 'green' ? 0.5 : 1 }}
              color={device.color}
            />,
          );
          i++;
            ...
            chart.push(
              <div
                style={{
                  ...
                  flexWrap: 'wrap',
                  gap: '1px',
                  marginLeft: j % 2 === 0 ? '0px' : '8px',
                  marginTop: j > 0 ? '-3px' : '0px',
                }}
              >
                {line}
              </div>,
