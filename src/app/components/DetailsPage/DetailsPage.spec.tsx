...
import { checkAccessibility, render, screen } from '@app/tests/test-utils';
...
describe('Details page', () => {
  ...
  describe('loading state', () => {
    it('Shows a spinner and not the content when data is loading', async () => {
      render(
    ...
    it('Shows the content and not the spinner when it is not loading', async () => {
